...
set :project, 'gestione_referti'  # Your application as its called in the repository
set :application, 'gestione-referti.convergent.it'  # Your app's location (domain or sub-domain name as setup in panel)
set :applicationdir, "/home/#{user}/#{application}"  # The standard Dreamhost setup
 
#github stuff
set :repository, "ssh://converge@convergent.it/~/repos/gestione_referti.git"
set :scm, :git
